                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            ...
                            <h4 class="text-uppercase">Mohon lengkapi profil untuk melanjutkan</h4>
                            <div class="mt-5 text-center">
                                <a class="btn btn-primary waves-effect waves-light" href="{{route('profil.index')}}">Menuju Halaman Profil</a>
                            </div>
                        </div>
                    </div>
                </div>
