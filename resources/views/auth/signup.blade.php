...
<head>
    ...
    <meta charset="utf-8" />
    <title>Registrasi | PT. PANUDUH ATMA WARAS</title>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-2">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{asset('assets/images/web/logo_pt.png')}}" alt="" height="40" class="auth-logo-dark">
                                        <img src="{{asset('assets/images/web/logo_pt.png')}}" alt="" height="40" class="auth-logo-light">
                                    </a>
                                </div>
                                <div class="my-auto">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted">Mohon isi form registrasi berikut</p>
                                    </div>
